...
| 0.2 | First paragraph names the customer, the problem, and the transformation delivered, so an unfamiliar exec understands why this matters in under 30 seconds | | |
...
---
*PRD Review Checklist v3.0, updated based on Amazon PRFAQ best practices.*
